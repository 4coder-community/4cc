...
{ PROC_LINKS(auto_indent_line_at_cursor, 0), false, CSTR_WITH_SIZE("auto_indent_line_at_cursor"), CSTR_WITH_SIZE("Auto-indents the line on which the cursor sits."), CSTR_WITH_SIZE("D:\\temp\\4cc\\code\\custom\\4coder_auto_indent.cpp"), 420 },
{ PROC_LINKS(auto_indent_range, 0), false, CSTR_WITH_SIZE("auto_indent_range"), CSTR_WITH_SIZE("Auto-indents the range between the cursor and the mark."), CSTR_WITH_SIZE("D:\\temp\\4cc\\code\\custom\\4coder_auto_indent.cpp"), 430 },
{ PROC_LINKS(auto_indent_whole_file, 0), false, CSTR_WITH_SIZE("auto_indent_whole_file"), CSTR_WITH_SIZE("Audo-indents the entire current buffer."), CSTR_WITH_SIZE("D:\\temp\\4cc\\code\\custom\\4coder_auto_indent.cpp"), 411 },
...
{ PROC_LINKS(write_text_and_auto_indent, 0), false, CSTR_WITH_SIZE("write_text_and_auto_indent"), CSTR_WITH_SIZE("Inserts text and auto-indents the line on which the cursor sits if any of the text contains 'layout punctuation' such as ;:{}()[]# and new lines."), CSTR_WITH_SIZE("D:\\temp\\4cc\\code\\custom\\4coder_auto_indent.cpp"), 440 },
