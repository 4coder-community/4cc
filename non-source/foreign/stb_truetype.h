...
STBTT_DEF int stbtt_BakeFontBitmap(const unsigned char *data, int offset,  // font location (use offset=0 for plain .ttf)
                                   ...
                                   void *user_allocator_context);          // context for overriden STBTT_malloc
...
STBTT_DEF int stbtt_BakeFontBitmap(const unsigned char *data, int offset,  // font location (use offset=0 for plain .ttf)
                                   ...
                                   unsigned char *pixels, int pw, int ph,  // bitmap to be filled in
                                   int first_char, int num_chars,          // characters to bake
                                   stbtt_bakedchar *chardata, void *user_allocator_callback)
{
   float scale;
   int x,y,bottom_y, i;
   stbtt_fontinfo info;
   info.userdata = user_allocator_callback;
   ...
   for (i=0; i < num_chars; ++i) {
      ...
      int g = stbtt_FindGlyphIndex(&info, first_char + i);
      ...
      stbtt_MakeGlyphBitmap(&info, pixels+x+y*pw, gw,gh,pw, scale,scale, g);
